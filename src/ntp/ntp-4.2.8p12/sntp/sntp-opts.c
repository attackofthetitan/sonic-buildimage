 ...
 *
 *  It has been AutoGen-ed  July 24, 2025 at 03:00:15 AM by AutoGen 5.18.12
...
/*  1513 */ "KOD\0"
/*  1517 */ "kod\0"
/*  1521 */ "/var/lib/sntp/kod\0"
/*  1539 */ "Look in this file for the key specified with -a\0"
/*  1587 */ "KEYFILE\0"
/*  1595 */ "keyfile\0"
/*  1603 */ "/etc/ntp.keys\0"
/*  1617 */ "Log to specified logfile\0"
/*  1642 */ "LOGFILE\0"
/*  1650 */ "logfile\0"
/*  1658 */ "Adjustments less than steplimit msec will be slewed\0"
/*  1710 */ "STEPLIMIT\0"
/*  1720 */ "steplimit\0"
/*  1730 */ "Send int as our NTP protocol version\0"
/*  1767 */ "NTPVERSION\0"
/*  1778 */ "ntpversion\0"
/*  1789 */ "Use the NTP Reserved Port (port 123)\0"
/*  1826 */ "USERESERVEDPORT\0"
/*  1842 */ "usereservedport\0"
/*  1858 */ "OK to 'step' the time with settimeofday(2)\0"
/*  1901 */ "STEP\0"
/*  1906 */ "step\0"
/*  1911 */ "OK to 'slew' the time with adjtime(2)\0"
/*  1949 */ "SLEW\0"
/*  1954 */ "slew\0"
/*  1959 */ "The number of seconds to wait for responses\0"
/*  2003 */ "TIMEOUT\0"
/*  2011 */ "timeout\0"
/*  2019 */ "Wait for pending replies (if not setting the time)\0"
/*  2070 */ "WAIT\0"
/*  2075 */ "no-wait\0"
/*  2083 */ "no\0"
...
/*  2226 */ "version\0"
/*  2234 */ "save the option state to a config file\0"
/*  2273 */ "save-opts\0"
/*  2283 */ "load options from a config file\0"
/*  2315 */ "LOAD_OPTS\0"
/*  2325 */ "no-load-opts\0"
/*  2338 */ "SNTP\0"
/*  2343 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p12\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n"
            "\t\t[ hostname-or-IP ...]\n\0"
/*  2503 */ "$HOME\0"
/*  2509 */ ".\0"
/*  2511 */ ".ntprc\0"
/*  2518 */ "http://bugs.ntp.org, bugs@ntp.org\0"
/*  2552 */ "\n\0"
/*  2554 */ "sntp 4.2.8p12";
...
#define KEYFILE_DESC      (sntp_opt_strs+1539)
/** Upper-cased name for the keyfile option */
#define KEYFILE_NAME      (sntp_opt_strs+1587)
...
#define KEYFILE_DFT_ARG   (sntp_opt_strs+1603)
...
#define LOGFILE_DESC      (sntp_opt_strs+1617)
/** Upper-cased name for the logfile option */
#define LOGFILE_NAME      (sntp_opt_strs+1642)
/** Name string for the logfile option */
#define LOGFILE_name      (sntp_opt_strs+1650)
...
#define STEPLIMIT_DESC      (sntp_opt_strs+1658)
/** Upper-cased name for the steplimit option */
#define STEPLIMIT_NAME      (sntp_opt_strs+1710)
/** Name string for the steplimit option */
#define STEPLIMIT_name      (sntp_opt_strs+1720)
...
#define NTPVERSION_DESC      (sntp_opt_strs+1730)
/** Upper-cased name for the ntpversion option */
#define NTPVERSION_NAME      (sntp_opt_strs+1767)
/** Name string for the ntpversion option */
#define NTPVERSION_name      (sntp_opt_strs+1778)
...
#define USERESERVEDPORT_DESC      (sntp_opt_strs+1789)
...
#define USERESERVEDPORT_name      (sntp_opt_strs+1842)
...
#define STEP_DESC      (sntp_opt_strs+1858)
/** Upper-cased name for the step option */
#define STEP_NAME      (sntp_opt_strs+1901)
/** Name string for the step option */
#define STEP_name      (sntp_opt_strs+1906)
...
#define SLEW_DESC      (sntp_opt_strs+1911)
/** Upper-cased name for the slew option */
#define SLEW_NAME      (sntp_opt_strs+1949)
/** Name string for the slew option */
#define SLEW_name      (sntp_opt_strs+1954)
...
#define TIMEOUT_DESC      (sntp_opt_strs+1959)
/** Upper-cased name for the timeout option */
#define TIMEOUT_NAME      (sntp_opt_strs+2003)
/** Name string for the timeout option */
#define TIMEOUT_name      (sntp_opt_strs+2011)
...
#define WAIT_DESC      (sntp_opt_strs+2019)
/** Upper-cased name for the wait option */
#define WAIT_NAME      (sntp_opt_strs+2070)
/** disablement name for the wait option */
#define NOT_WAIT_name  (sntp_opt_strs+2075)
/** disablement prefix for the wait option */
#define NOT_WAIT_PFX   (sntp_opt_strs+2083)
 ...
 */
#define HELP_DESC       (sntp_opt_strs+2086)
#define HELP_name       (sntp_opt_strs+2130)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (sntp_opt_strs+2135)
#define MORE_HELP_name  (sntp_opt_strs+2180)
...
#endif
#define VER_DESC        (sntp_opt_strs+2190)
#define VER_name        (sntp_opt_strs+2226)
#define SAVE_OPTS_DESC  (sntp_opt_strs+2234)
#define SAVE_OPTS_name  (sntp_opt_strs+2273)
#define LOAD_OPTS_DESC     (sntp_opt_strs+2283)
#define LOAD_OPTS_NAME     (sntp_opt_strs+2315)
#define NO_LOAD_OPTS_name  (sntp_opt_strs+2325)
#define LOAD_OPTS_pfx      (sntp_opt_strs+2083)
...
#define zPROGNAME       (sntp_opt_strs+2338)
/** Reference to the title line for sntp usage. */
#define zUsageTitle     (sntp_opt_strs+2343)
/** sntp configuration file name. */
#define zRcName         (sntp_opt_strs+2511)
