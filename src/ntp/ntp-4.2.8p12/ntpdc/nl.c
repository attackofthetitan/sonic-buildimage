  ...
  printf("offsetof(lamport) = %d\n", 
	 (int) offsetof(struct info_sys_stats, lamport));
  printf("offsetof(tsrounding) = %d\n", 
	 (int) offsetof(struct info_sys_stats, tsrounding));
  printf("\n");
  ...
  printf("offsetof(rflags) = %d\n", 
	 (int) offsetof(struct info_restrict, rflags));
  ...
  printf("offsetof(ippeerlimit) = %d\n", 
	 (int) offsetof(struct conf_restrict, ippeerlimit));
  printf("offsetof(flags) = %d\n", 
