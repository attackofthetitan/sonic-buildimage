...
class SfpUtil(SfpUtilBase):
    ...
    def init_global_port_presence(self):
        for port_num in range(self.port_start, (self.port_end + 1)):
            ...
            if presence:
                self._global_port_pres_dict[port_num] = SFP_STATUS_INSERTED
            else:
                self._global_port_pres_dict[port_num] = SFP_STATUS_REMOVED
        ...
        while True:
            ...
            for port_num in range(self.port_start, (self.port_end + 1)):
                ...
                if (presence and
                        self._global_port_pres_dict[port_num] == SFP_STATUS_REMOVED):
                    self._global_port_pres_dict[port_num] = SFP_STATUS_INSERTED
                    port_dict[port_num] = SFP_STATUS_INSERTED
                elif (not presence and
                        self._global_port_pres_dict[port_num] == SFP_STATUS_INSERTED):
                    self._global_port_pres_dict[port_num] = SFP_STATUS_REMOVED
                    port_dict[port_num] = SFP_STATUS_REMOVED
